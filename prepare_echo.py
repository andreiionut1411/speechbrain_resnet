...
def prepare_echo(
    ...
    """
    Prepares the json files for the Echo dataset.
    ...
    ---------
    data_folder : str
        Path to the folder where the Echo dataset is stored.
    save_json_train : str
    ...
    train_folder = os.path.join(data_folder, "wavs")
...
def download_mini_librispeech(destination):
    ...
    """
    train_archive = os.path.join(destination, "test.zip")
