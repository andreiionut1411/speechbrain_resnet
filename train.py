...
from prepare_echo import prepare_echo
...
class SpkIdBrain(sb.Brain):
	...
	def compute_objectives(self, predictions, batch, stage):
		...
		# These are for ecapa and r-vector
		logsoftmax_wrapper = sb.nnet.losses.LogSoftmaxWrapper(loss_fn=sb.nnet.losses.AdditiveAngularMargin(margin=0.2, scale=30))
		loss = logsoftmax_wrapper(predictions, spkid, lens)
